...
<div class="panel panel-default">
          ...
          <div class="col-md-3 market-update-gd">
              <div class="market-update-block clr-block-3">
                  ...
                  <div class="col-md-8 market-update-left" style="width:100%">
                      ...
                      <h3 class="price_format">{{ $sotiendauvao }}</h3>
  ...
  <div class="panel panel-default">
    ...
    <footer class="panel-footer">
      <div class="row">
        <div class="row">
          <form action="{{ route('locthongkedaura', ['id' => $item3->first()->id]) }}" method="GET">
            <div class="col-md-12">    
            <div class="col-sm-5 m-b-xs" style="margin-bottom: -29px;">
              <div class="xuongdong" style="display: flex">
                <div class="keben">
...
<script type="text/javascript">
  ...
  Morris.Donut({
    ...
    data: [
        {label:"Số tiền vốn", value:{{ $demVon }}},
        {label:"Số tiền lãi", value:{{ $demLai }}},
    ]
  });
</script>
<script type="text/javascript">
